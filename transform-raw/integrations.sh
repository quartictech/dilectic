...
unzip $INPUT/LSOAs.zip "data/Lower_layer_super_output_areas_(E+W)_2001_Boundaries_(Full_Extent)_V2.zip"
unzip "data/Lower_layer_super_output_areas_(E+W)_2001_Boundaries_(Full_Extent)_V2.zip" 
shp_to_sql LSOA_2001_EW_BFE_V2.shp lsoa_2001_ew_bfe_v2 27700

unzip $INPUT/LSOAs.zip "data/Lower_layer_super_output_areas_(E+W)_2011_Boundaries_(Full_Extent)_V2.zip"
unzip "data/Lower_layer_super_output_areas_(E+W)_2011_Boundaries_(Full_Extent)_V2.zip" 
